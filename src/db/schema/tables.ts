...
export const accountDetail = mysqlTable("account_detail", {
  ...
  typeCode: char("type_code", { length: 1 }),
  loginTypeCode: char("login_type_code", { length: 2 }),
  idSourceType: char("id_source_type", { length: 1 }).notNull().default("1"),
  idMasterId: bigint("id_master_id", { mode: "number", unsigned: true }),
  loginId: varchar("login_id", { length: 255 }),
  passwordSourceType: char("password_source_type", { length: 1 }).notNull().default("1"),
  passwordMasterId: bigint("password_master_id", { mode: "number", unsigned: true }),
